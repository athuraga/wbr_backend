...
class NotificationTemplateController extends Controller
{
    ...
    public function send_notification()
    {
        ...
        {
            $q->where('title','vehicle');
        })->get();
        $vehicles = [];
        foreach ($vUsers as $vUser) {
            array_push($vehicles,Vehicle::where('user_id',$vUser->id)->first());
        }
        return view('admin.notification template.send_notification',compact('users','vehicles'));
    }
    ...
    public function send_notification_vehicle(Request $request)
    {
        $request->validate([
            'title' => 'bail|required',
            'message' => 'bail|required',
