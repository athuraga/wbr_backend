...
class SettingController extends Controller
{
    ...
    public function update_vehicle_notification(Request $request)
    {
        $data = $request->all();
        $id = GeneralSetting::first();
        $data['vehicle_notification'] = 1;
        $onesignal['vehicle_app_id']=$request->vehicle_app_id;
        $onesignal['vehicle_auth_key'] = $request->vehicle_auth_key;
        $onesignal['vehicle_api_key'] = $request->vehicle_api_key;
        $this->updateENV($onesignal);
        $id->update($data);
        return redirect('admin/notification_setting')->with('msg','setting changed successfully..!!');
    }
    ...
    public function update_mail_setting(Request $request)
    {
        ...
        $data['vehicle_mail'] = $request->has('vehicle_mail') ? 1 : 0;
