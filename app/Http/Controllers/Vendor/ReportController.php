...
class ReportController extends Controller
{
    public function user_report(Request $request)
    {
        ...
        return view('vehicle.report.user_report',compact('users','currency','active_user','block_user'));
    }
    ...
    public function order_report(Request $request)
    {
        ...
        {
            $date = explode(' - ',$request->date_range);
            $orders = Order::whereBetween('created_at', [$date[0].' 00:00', $date[1].' 23:59'])->where('vehicle_id',$vehicle->id)->get();
        }
        else
        {
        ...
        $currency = GeneralSetting::first()->currency_symbol;
        return view('vehicle.report.order_report',compact('orders','currency'));
    }
}
