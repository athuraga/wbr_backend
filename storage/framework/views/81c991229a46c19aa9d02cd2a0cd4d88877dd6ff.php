            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark mb-5 font-weight-normal"><?php echo e(__('')); ?><span
                                class="font-weight-bold"><?php echo e(__('Weber Mobility')); ?></span>
                        </h4>
                        <?php if($errors->any()): ?>
                        ...
                        <form method="POST" action="<?php echo e(url('confirm_login')); ?>">
                            ...
                            <div class="form-group text-center">
                                <a href="<?php echo e(url('vehicle/login')); ?>"><?php echo e(__('Vehicle Login')); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
</html><?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/auth/login.blade.php ENDPATH**/ ?>