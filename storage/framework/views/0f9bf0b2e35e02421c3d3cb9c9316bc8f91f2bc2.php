...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a
                    href="<?php echo e(url('admin/vehicletype')); ?>"><?php echo e(__('Create vehicletype')); ?></a></div>
    ...
    <div class="section-body">
        ...
        <form class="container-fuild" action="<?php echo e(url('admin/vehicletype')); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for=""><?php echo e(__('Name of Vehicletype')); ?><span class="text-danger">&nbsp;*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-primary"><?php echo e(__('Create Vehicletype')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app',['activePage' => 'vehicletype'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/admin/vehicletype/create_vehicletype.blade.php ENDPATH**/ ?>