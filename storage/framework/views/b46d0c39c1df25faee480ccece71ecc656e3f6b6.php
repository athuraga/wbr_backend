...
<body>
    ...
    <?php if(Request::is('admin/make_payment')): ?>
        ...
        <script src="https://www.paypal.com/sdk/js?client-id=<?php echo e(App\Models\PaymentSetting::first()->paypal_sendbox); ?>&currency=<?php echo e(App\Models\GeneralSetting::first()->currency); ?>"
    ...
    <?php if(Request::is('admin/delivery_zone_area/*') || Request::is('vehicle/deliveryZoneArea/*')): ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(App\Models\GeneralSetting::first()->map_key); ?>&callback=initMap&libraries=places&v=weekly"
                defer></script>
...
<?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/layouts/app.blade.php ENDPATH**/ ?>