    ...
    <ul class="navbar-nav navbar-right">
        <?php if(Auth::user()->load('roles')->roles->contains('title', 'vehicle')): ?>
            <?php
                ...
                $toDay = App\Models\Notification::where([['user_type','vehicle'],['user_id',$vehicle->id]])->whereBetween('created_at', [Carbon\Carbon::now()->format('Y-m-d')." 00:00:00",  Carbon\Carbon::now()->format('Y-m-d')." 23:59:59"])->get();
                $notifications = App\Models\Notification::where([['user_type','vehicle'],['user_id',$vehicle->id]])->get()->take(5);
            ?>
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-footer text-center">
                    <a href="<?php echo e(url('vehicle/notification')); ?>"><?php echo e(__('View all')); ?><i class="fas fa-chevron-right"></i></a>
                </div>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <?php if(Auth::user()->load('roles')->roles->contains('title', 'vehicle')): ?>
                <a href="<?php echo e(url('vehicle/update_vehicle')); ?>" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> <?php echo e(__('Profile Settings')); ?>

                </a>
                <a href="<?php echo e(url('vehicle/printer_setting')); ?>" class="dropdown-item has-icon">
                    <i class="fas fa-print"></i> <?php echo e(__('Printer Settings')); ?>

                </a>
                <a href="<?php echo e(url('vehicle/change_password')); ?>" class="dropdown-item has-icon">
...
<?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/layouts/topnav.blade.php ENDPATH**/ ?>