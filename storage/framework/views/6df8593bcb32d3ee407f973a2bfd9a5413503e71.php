        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card card-large-icons">
                    ...
                    <div class="card-body">
                        <h4><?php echo e(__('User / vehicle Verification setting')); ?></h4>
                        <p><?php echo e(__('Bussiness static pages like help about us privacy policy etc.')); ?></p>
...
<?php echo $__env->make('layouts.app',['activePage' => 'setting'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/admin/setting/setting.blade.php ENDPATH**/ ?>