<div class="main-sidebar" style="overflow: auto;">
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li class="<?php echo e($activePage == 'send_notification' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('admin/send_notification')); ?>"><?php echo e(__('Send Notification')); ?></a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_reports')): ?>
            <li
                class="dropdown <?php echo e($activePage == 'user_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'order_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'vendor_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'driver_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'earning_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'wallet_transaction_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'deposit_report' ? 'active' : ''); ?>">
                <a href="javascript:void(0);" class="nav-link has-dropdown">
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="<?php echo e($activePage == 'user_report' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('admin/user_report')); ?>"><?php echo e(__('User reports')); ?></a>
                    </li>
                    <li class="<?php echo e($activePage == 'order_report' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('admin/order_report')); ?>"><?php echo e(__('Order reports')); ?></a>
                    </li>
                    ...
                    <li class="<?php echo e($activePage == 'vendor_report' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('admin/vendor_report')); ?>"><?php echo e(__('Vendor reports')); ?></a>
                    </li>
            ...
            <li
                class="dropdown <?php echo e($activePage == 'user_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'order_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'vendor_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'driver_report' ? 'active' : ''); ?> || <?php echo e($activePage == 'earning_report' ? 'active' : ''); ?>">
                <a href="javascript:void(0);" class="nav-link has-dropdown">
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="<?php echo e($activePage == 'user_report' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('vendor/user_report')); ?>"><?php echo e(__('User reports')); ?></a>
                    </li>
                    <li class="<?php echo e($activePage == 'order_report' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('vendor/order_report')); ?>"><?php echo e(__('Order reports')); ?></a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <li
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="<?php echo e($activePage == 'delivery_timeslot' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('vendor/vendor/delivery_timeslot')); ?>"><?php echo e(__('delivery timeslots')); ?></a>
                    </li>
                    <li class="<?php echo e($activePage == 'pickup_timeslot' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('vendor/vendor/pickup_timeslot')); ?>"><?php echo e(__('Pick up timeslots')); ?></a>
                    </li>
                    <li class="<?php echo e($activePage == 'selling_timeslot' ? 'active' : ''); ?>"><a
                            href="<?php echo e(url('vendor/vendor/selling_timeslot')); ?>"><?php echo e(__('selling timeslots')); ?></a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
