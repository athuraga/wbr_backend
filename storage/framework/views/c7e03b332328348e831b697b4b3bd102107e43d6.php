...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead"><?php echo e(__('Edit vehicle detail')); ?></p>
        <form class="container-fuild" action="<?php echo e(url('admin/vehicle/'.$vehicle->id)); ?>" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="logoContainer">
                                <img id="image" src="<?php echo e($vehicle->image); ?>" width="180" height="150">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <div class="logoContainer">
                                <img id="licence_doc" src="<?php echo e($vehicle->vehicle_logo); ?>" width="180" height="150">
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="<?php echo e(__('Vehicle Name')); ?>" value="<?php echo e($vehicle->name); ?>" required="">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="<?php echo e(__('Email')); ?>"><?php echo e(__('Email Address')); ?><span
                                    class="text-danger">&nbsp;*</span></label>
                            <input type="email" name="email_id" value="<?php echo e($vehicle->email_id); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="<?php echo e(__('Email Address')); ?>" readonly>
                                ...
                                <div class="col-md-3 p-0">
                                    <select name="phone_code" required class="form-control select2">
                                        ...
                                        <option value="+<?php echo e($phone_code->phonecode); ?>"
                                            <?php echo e($user->phone_code == $phone_code->phonecode ? 'selected' : ''); ?>>
                                            +<?php echo e($phone_code->phonecode); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-9 p-0">
                                    <input type="number" name="contact" value="<?php echo e($vehicle->contact); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <h6 class="c-grey-900"><?php echo e(__('Select Tags (For Vehicles it will be vehicletypes)')); ?></h6>
                </div>
                <div class="card-body">
                    <div class="mT-30">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="select2 form-control" name="vehicletype_id[]" multiple="true">
                                    ...
                                    <option value="<?php echo e($vehicletype->id); ?>"
                                        <?php echo e(in_array($vehicletype->id,explode(',',$vehicle->vehicletype_id)) ? 'selected' : ''); ?>>
                                ...
                                <div class="row">
                                    <div class="pac-card col-md-12 mb-3" id="pac-card">
                                        ...
                                        <div id="pac-container">
                                            <input id="pac-input" name="map_address" value="<?php echo e($vehicle->map_address); ?>"
                                                type="text" class="form-control" placeholder="Enter A Location" />
                                            <input type="hidden" name="lat" value="<?php echo e($vehicle->lat); ?>" id="lat">
                                            <input type="hidden" name="lang" value="<?php echo e($vehicle->lang); ?>" id="lang">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="address"
                                            value="<?php echo e($vehicle->address); ?>" placeholder="<?php echo e(__('Vehicle Full Address')); ?>"
                                            id="location">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" min=1 name="min_order_amount"
                                    placeholder="<?php echo e(__('Minimum Ride Amount')); ?>" value="<?php echo e($vehicle->min_order_amount); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="avg_delivery_time"><?php echo e(__('Avg. Run Time(in min)/Full Charge')); ?><span
                                        class="text-danger">&nbsp;*</span></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary"
                                type="submit"><?php echo e(__('Update Vehicle')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app',['activePage' => 'vehicle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wbr/Sites/wbr_backend/resources/views/admin/vehicle/edit_vehicle.blade.php ENDPATH**/ ?>