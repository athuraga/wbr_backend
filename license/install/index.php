...
<head>
    <meta charset="utf-8" />
    <title>Weber Mobility - Installer</title>
    ...
    <div class="container">
        <div class="section">
            <div class="column is-6 is-offset-3">
                <center>
                    <h1 class="title" style="padding-top: 20px">Weber Mobility</h1><br>
                </center>
                <div class="box">
                    <?php
                    switch ($step) {
                    ...
                    <form action="#" id="admin-detal-form" method="POST">
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="email" value="contact@webermobility.tech" id="email"
                                    placeholder="Enter your admin email" name="email" required readonly>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="text" id="password" placeholder="Enter your admin password"
                                    value="123456" name="password" readonly required>
