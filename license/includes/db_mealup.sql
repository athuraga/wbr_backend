...
CREATE TABLE `general_setting` (
  ...
  `vehicle_notification` tinyint(4) DEFAULT NULL,
  `vehicle_app_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_auth_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_api_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `vehicle_mail` tinyint(1) DEFAULT NULL,
  `driver_mail` tinyint(1) DEFAULT NULL,
  `ios_customer_version` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ios_vehicle_version` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ios_vehicle_app_url` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `android_vehicle_version` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `android_vehicle_app_url` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(8, '2020_10_21_094358_create_vehicletype_table', 6),
(9, '2020_10_21_122833_create_vehicle_table', 7),
...
(16, '2020_10_28_100818_create_vehicle_discount_table', 14),
...
(22, '2020_10_31_072226_create_vehicle_bank_details_table', 20),
...
(9, 'delivery person order', 'delivery person order', 'dear {driver_name} Recently Booked Order Near {address} From {vehicle_name}', '<p>dear {driver_name} recently booked order near {address} from {vehicle_name}<br></p>', 'Querida {driver_name} Pedido recientemente reservado cerca de {dirección} De {vehicle_name}', '<p> querido {driver_name} pedido recientemente reservado cerca de {address} de {vehicle_name} <br> </p>', '2020-12-22 19:44:14', '2021-02-11 07:16:59'),
(10, 'vehicle order', 'vehicle order', 'Dear {Vehicle_name} We Liked To Inform You That Recently Booked Order. Order Id : {Order_id} , User Name : {User_name}', '<p>Dear {Vehicle_name} We Liked To Inform You That Recently Booked Order.</p><hr><p>Order Id : {Order_id}</p><p>User Name : {User_name}</p>', 'Estimado {Vehicle_name}, nos gustaría informarle sobre el pedido reservado recientemente. ID de pedido: {Order_id}, nombre de usuario: {User_name}', '<p> Estimado {Vehicle_name}, nos gustaría informarle sobre el pedido reservado recientemente. </p> <hr> <p> ID del pedido: {Order_id} </p> <p> Nombre de usuario: {User_name} </p>', '2020-12-25 05:04:19', '2021-02-11 07:16:59');
...
CREATE TABLE `order` (
  ...
  `vehicle_discount_id` bigint(20) UNSIGNED DEFAULT NULL,
  `vehicle_discount_price` int(11) DEFAULT 0,
  ...
  `vehicle_pending_amount` int(11) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_setting` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `vehicle_order_max_time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `order_setting` (`id`, `vehicle_order_max_time`, `driver_order_max_time`, `delivery_charge_type`, `charges`, `created_at`, `updated_at`) VALUES
...
(21, 'admin_vehicle_access', NULL, NULL),
(22, 'admin_vehicle_add', NULL, NULL),
(23, 'admin_vehicle_edit', NULL, NULL),
(24, 'admin_vehicle_delete', NULL, NULL),
(25, 'vehicletype_access', NULL, NULL),
(26, 'vehicletype_add', NULL, NULL),
(27, 'vehicletype_edit', NULL, NULL),
(28, 'vehicletype_delete', NULL, NULL),
...
(80, 'admin_vehicle_discount_access', NULL, NULL),
(81, 'vehicle_discount_add', NULL, NULL),
(82, 'vehicle_discount_edit', NULL, NULL),
(83, 'vehicle_discount_delete', NULL, NULL),
(84, 'admin_vehicle_financeDetails', NULL, NULL),
(85, 'admin_vehicle_password', NULL, NULL),
(86, 'admin_vehicle_bankDetails', NULL, NULL),
(87, 'admin_vehicle_sellingTimeslots', NULL, NULL),
(88, 'admin_vehicle_pickupTimeslots', NULL, NULL),
(89, 'admin_vehicle_deliveryTimeslots', NULL, NULL),
(90, 'admin_vehicle_reviews', NULL, NULL),
(91, 'vehicle_discount_access', NULL, NULL),
(92, 'vehicle_financeDetails', NULL, NULL),
(93, 'vehicle_reviews', NULL, NULL),
(94, 'menu_category_access', NULL, NULL),
(95, 'vehicle_bank_details', NULL, NULL),
(96, 'vehicle_deliveryTimeslots', NULL, NULL),
(97, 'vehicle_pickupTimeslots', NULL, NULL),
(98, 'vehicle_sellingTimeslots', NULL, NULL),
(99, 'vehicle_order_access', NULL, NULL),
(100, 'vehicle_order_add', NULL, NULL),
(101, 'vehicle_submenu_access', NULL, NULL),
(102, 'vehicle_submenu_add', NULL, NULL),
(103, 'vehicle_submenu_edit', NULL, NULL),
(104, 'vehicle_menu_access', NULL, NULL),
(105, 'vehicle_menu_add', NULL, NULL),
(106, 'vehicle_menu_edit', NULL, NULL),
(107, 'vehicle_custimization_access', NULL, NULL),
(108, 'vehicle_custimization_add', NULL, NULL),
(109, 'vehicle_custimization_edit', NULL, NULL),
(110, 'vehicle_order_add', NULL, NULL),
(112, 'order_access', NULL, NULL),
(113, 'access_settelments', NULL, NULL),
(114, 'edit_settelments', NULL, NULL),
(115, 'vehicle_bank_details', NULL, NULL),
(116, 'vehicle_custimization_type_access', NULL, NULL),
(117, 'vehicle_custimization_type_add', NULL, NULL),
(118, 'vehicle_custimization_type_edit', NULL, NULL),
(119, 'vehicle_custimization_type_delete', NULL, NULL),
(120, 'admin_dashboard', NULL, NULL),
(121, 'vehicle_dashboard', NULL, NULL),
(122, 'admin_reports', NULL, NULL),
(123, 'vehicle_reports', NULL, NULL),
...
CREATE TABLE `promo_code` (
  ...
  `vehicle_id` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(4, 'vehicle', '2020-11-03 06:44:54', '2020-11-03 06:44:54');
...
CREATE TABLE `settlements` (
  ...
  `vehicle_earning` int(11) NOT NULL,
...
CREATE TABLE `vehicle` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vehicle_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicletype_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `vehicle_own_driver` int(11) DEFAULT NULL,
  `payment_option` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) DEFAULT NULL,
  `vehicle_language` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `vehicle_bank_details`
--

CREATE TABLE `vehicle_bank_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `vehicle_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `vehicle_discount`
--

CREATE TABLE `vehicle_discount` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vehicle_id` bigint(20) UNSIGNED NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `delivery_person`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_delivery_person_vehicle_id` (`vehicle_id`),
...
ALTER TABLE `menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_menu_vehicle_id` (`vehicle_id`);
...
ALTER TABLE `review`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_review_vehicle_id` (`vehicle_id`),
...
ALTER TABLE `settlements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_settlement_vehicle_id` (`vehicle_id`),
...
ALTER TABLE `submenu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_submenu_menu_id` (`vehicle_id`);
...
ALTER TABLE `submenu_cutsomization_type`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_custimization_type_vehicle_id` (`vehicle_id`);
...
ALTER TABLE `vehicle`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `vehicle_email_unique` (`email_id`),
  ADD KEY `fk_vehicle_user_id` (`user_id`);

--
-- Indexes for table `vehicle_bank_details`
--
ALTER TABLE `vehicle_bank_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_bank_details_vehicle_id` (`vehicle_id`);

--
-- Indexes for table `vehicle_discount`
--
ALTER TABLE `vehicle_discount`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_vehicle_discount_vehicle_id` (`vehicle_id`);
...
ALTER TABLE `working_hours`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_working_vehicle_id` (`vehicle_id`);
...
--
-- AUTO_INCREMENT for table `vehicle_bank_details`
--
ALTER TABLE `vehicle_bank_details`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vehicle_discount`
--
ALTER TABLE `vehicle_discount`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `delivery_person`
  ...
  ADD CONSTRAINT `fk_delivery_person_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `menu`
  ADD CONSTRAINT `fk_menu_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `order`
  ...
  ADD CONSTRAINT `fk_order_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_promo_code_id` FOREIGN KEY (`promocode_id`) REFERENCES `promo_code` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_vehicle_discount_id` FOREIGN KEY (`vehicle_discount_id`) REFERENCES `vehicle_discount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `fk_review_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `settlements`
  ...
  ADD CONSTRAINT `fk_settlement_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `submenu`
--
ALTER TABLE `submenu`
  ADD CONSTRAINT `fk_submenu_menu_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_submenu_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `submenu_cutsomization_type`
--
ALTER TABLE `submenu_cutsomization_type`
  ADD CONSTRAINT `fk_custimization_type_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `vehicle`
  ADD CONSTRAINT `fk_vehicle_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `vehicle_bank_details`
--
ALTER TABLE `vehicle_bank_details`
  ADD CONSTRAINT `fk_bank_details_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `vehicle_discount`
--
ALTER TABLE `vehicle_discount`
  ADD CONSTRAINT `fk_vehicle_discount_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `working_hours`
  ADD CONSTRAINT `fk_working_vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
