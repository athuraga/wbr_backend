(function($) {
    ...
    var GmzSearchVehicle = {
        ...
        init: function(el) {
            ...
            this.renderEl = $('.list-vehicle__content', this.container);
        ...
        _initSearch: function() {
            ...
            base.xhrRequest = $.post(base.container.data('action'), base.dataFilter, function(respon) {
                ...
                if ($('.list-half-map__left .list-vehicle__content').length) {
                    $('.list-vehicle__content', parentImage).find('img').one("load", function() {
                        $(this).addClass('loaded');
                        if ($('.list-vehicle__content', parentImage).find('img.loaded').length === $('.list-vehicle__content', parentImage).find('img').length) {
                            setTimeout(function() {
    ...
    $(document).ready(function() {
        GmzSearchVehicle.init('.gmz-search-result');
    });
})(jQuery);