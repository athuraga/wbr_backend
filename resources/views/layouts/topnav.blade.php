    ...
    <ul class="navbar-nav navbar-right">
        @if(Auth::user()->load('roles')->roles->contains('title', 'vehicle'))
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-footer text-center">
                    <a href="{{ url('vehicle/notification') }}">{{__('View all')}}<i class="fas fa-chevron-right"></i></a>
                </div>
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                @if(Auth::user()->load('roles')->roles->contains('title', 'vehicle'))
                <a href="{{ url('vehicle/update_vehicle') }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> {{__('Profile Settings')}}
                </a>
                <a href="{{ url('vehicle/printer_setting') }}" class="dropdown-item has-icon">
                    <i class="fas fa-print"></i> {{__('Printer Settings')}}
                </a>
                <a href="{{ url('vehicle/change_password') }}" class="dropdown-item has-icon">
