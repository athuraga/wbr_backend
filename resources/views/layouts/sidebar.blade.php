<div class="main-sidebar" style="overflow: auto;">
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="{{ $activePage == 'notification_template' ? 'active' : ''}}"><a
                            href="{{ url('admin/notification_template') }}">{{__('Notification Template')}}</a></li>
            ...
            <li
                ...
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li class="{{ $activePage == 'wallet_transaction_report' ? 'active' : ''}}"><a
                            href="{{ url('admin/wallet_withdraw_report') }}">{{__('Wallet withdraw reports')}}</a></li>
                    <li class="{{ $activePage == 'deposit_report' ? 'active' : ''}}"><a
                            href="{{ url('admin/wallet_deposit_report') }}">{{__('Wallet Deposit reports')}}</a></li>
            ...
            @if(Gate::check('vehicle_deliveryTimeslots') || Gate::check('vehicle_pickupTimeslots') ||
            Gate::check('vehicle_sellingTimeslots'))
            <li
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="{{ $activePage == 'delivery_timeslot' ? 'active' : ''}}"><a
                            href="{{ url('vehicle/vehicle/delivery_timeslot') }}">{{__('delivery timeslots')}}</a></li>
                    <li class="{{ $activePage == 'pickup_timeslot' ? 'active' : ''}}"><a
                            href="{{ url('vehicle/vehicle/pickup_timeslot') }}">{{__('Pick up timeslots')}}</a></li>
                    <li class="{{ $activePage == 'selling_timeslot' ? 'active' : ''}}"><a
                            href="{{ url('vehicle/vehicle/selling_timeslot') }}">{{__('selling timeslots')}}</a></li>
                </ul>
            </li>
            @endif
        </ul>
