@extends('layouts.app',['activePage' => 'map'])
   ...
   <div class="box box-block bg-white">
      ...
      <div class="row">
         ...
         <div class="col-md-2">
            ...
            <div class="col-md-2">
               <label class="custom-control custom-checkbox">
               <input type="radio" value="owner" class="custom-control-input" name="type">
               <span class="custom-control-indicator"></span>
               <span class="custom-control-description">Owner</span>
               </label>
            </div>
            <div class="col-md-2">
               <label class="custom-control custom-checkbox">
...
<script>
   ...
   function initMap() {
      ...
      //   $.get('{{url("admin/vehicle/show_vehicle")}}/'+type).then(res=>{
      //       clearMarkers();
      //       setMarkers(map, res)
      //   })
      }
