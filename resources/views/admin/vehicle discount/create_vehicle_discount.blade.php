...
@section('title','Create A Vehicle Discount')
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ url('admin/vehicle_discount/'.$id) }}">{{__('vehicle discount')}}</a></div>
            <div class="breadcrumb-item">{{__('create vehicle discount')}}</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <p class="section-lead">{{__('create Vehicle discount')}}</p>
        <form class="container-fuild" action="{{ url('admin/vehicle_discount') }}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="card">
                <div class="card-body">
