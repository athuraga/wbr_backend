                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade active show" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label for="{{__('vehicle_notification')}}">{{__('vehicle notification')}}</label><br>
                                            <label class="switch">
                                                <input type="checkbox" name="vehicle_notification" {{ $notification_setting->vehicle_notification == '1' ? 'checked' : '' }}>
                                                <div class="slider"></div>
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="card mt-5 vehicle_notification_card {{ $notification_setting->vehicle_notification == 0 ? 'hide' : '' }}">
                                <div class="card-header">
                                    {{__('vehicle notification')}}
                                </div>
                                <form action="{{ url('admin/update_vehicle_notification') }}" method="post">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="onesignal_app_id">{{__('One signal app id')}}</label>
                                                <input type="text" name="vehicle_app_id" required value="{{ $notification_setting->vehicle_app_id }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="onesignal_app_id">{{__('One signal auth key')}}</label>
                                                <input type="text" name="vehicle_auth_key" required value="{{ $notification_setting->vehicle_auth_key }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="onesignal_app_id">{{__('One signal api key')}}</label>
                                                <input type="text" name="vehicle_api_key" required value="{{ $notification_setting->vehicle_api_key }}" class="form-control">
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                            <form action="{{ url('admin/update_mail_setting') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="{{__('vehicle_notification')}}">{{__('vehicle mail notification')}}</label><br>
                                        <label class="switch">
                                            <input type="checkbox" name="vehicle_mail" {{ $notification_setting->vehicle_mail == '1' ? 'checked' : '' }}>
                                            <div class="slider"></div>
                                        </label>
                                    </div>
                                    <div class="col-md-4">
