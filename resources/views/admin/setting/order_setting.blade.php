        ...
        <form action="{{ url('admin/update_order_setting') }}" method="post">
            ...
            <div class="card card-primary mt-3">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="">{{__('order cancel thresold by vehicle(In minutes)')}}</label>
                            <input type="number" min=1 value="{{ $orderData->vehicle_order_max_time }}" required name="vehicle_order_max_time" class="form-control">
                        </div>
                        <div class="col-md-6">
