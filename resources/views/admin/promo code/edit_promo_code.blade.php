        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="container-fuild" action="{{ url('admin/promo_code/'.$promoCode->id) }}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            <label for="vehicle">{{__('Promo code valid for this Vehicle')}}<span class="text-danger">&nbsp;*</span></label>
                            <select name="vehicle_id[]" class="select2 form-control" multiple>
                                @foreach ($vehicles as $vehicle)
                                    <option value="{{$vehicle->id}}" {{in_array($vehicle->id,explode(',',$promoCode->vehicle_id)) ? 'selected' : ''}}>{{ $vehicle->name }}</option>
                                @endforeach
                            </select>
                        </div>

                        <div class="col-md-6 mb-5">
                            <label for="vehicle">{{__('Promo code valid for this Customer')}}<span class="text-danger">&nbsp;*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-5">
                            <label for="vehicle">{{__('Maximum discount amount')}}<span class="text-danger">&nbsp;*</span></label>
