...
@section('title','Create A Fleet operator')

@section('content')

<section class="section">
    <div class="section-header">
        <h1>{{__('Create Fleet operator')}}</h1>
        <div class="section-header-breadcrumb">
            @if(Auth::user()->load('roles')->roles->contains('title', 'admin'))
                ...
                <div class="breadcrumb-item">{{__('create a Fleet operator')}}</div>
            @endif
            @if(Auth::user()->load('roles')->roles->contains('title', 'vehicle'))
                ...
                <div class="breadcrumb-item"><a href="{{ url('vehicle/deliveryPerson') }}">{{__('Fleet operator')}}</a></div>
                <div class="breadcrumb-item">{{__('create a Fleet operator')}}</div>
            @endif
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <p class="section-lead">{{__('create Fleet operator')}}</p>
                ...
                <div class="card-body">
                    <div class="mT-30">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary" type="submit">{{__('Add Fleet operator')}}</button>
                        </div>
                    </div>
                </div>
            </div>
