...
@section('title','Fleet operator Detail Finance Details')
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ url('fleet operator detail/fleet operator detail_home') }}">{{__('Dashboard')}}</a></div>
    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header text-right">
                ...
                <span class="badge badge-danger">{{__('rs fleet operator gives to admin')}}</span>&nbsp;
                <span class="badge badge-success">{{__('rs admin gives to fleet operator')}}</span>
            </div>
            <div class="card-body">
                <table id="datatable" class="table table-striped table-bordered text-center" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>{{__('fleet operator earning')}}</th>
