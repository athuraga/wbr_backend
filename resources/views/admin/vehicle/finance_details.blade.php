...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">{{__('vehicle finance details')}}</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header text-right">
                ...
                <span class="badge badge-success">{{__('admin gives to vehicle')}}</span>&nbsp;
                <span class="badge badge-danger">{{__('vehicle gives to admin')}}</span>
            </div>
            <div class="card-body">
