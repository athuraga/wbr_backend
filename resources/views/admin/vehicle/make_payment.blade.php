...
@section('title','Vehicle Payment')

@section('content')

<section class="section">
    <div class="section-header">
        <h1>{{ $vehicle->name }}&nbsp;{{ "Settlement" }}</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ url('admin/home') }}">{{__('Dashboard')}}</a></div>
            <div class="breadcrumb-item active">
                <a href="{{ url('admin/vehicle/'.$vehicle->id) }}">{{ App\Models\Vehicle::find($vehicle->id)->name }}</a>
            </div>
            <div class="breadcrumb-item">{{__('vehicle payment')}}</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <h2 class="section-title">{{__("Vehicle payment")}}</h2>
        <p class="section-lead">{{__('Vehicle payment')}}</p>
        <div class="row">
