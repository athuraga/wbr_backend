                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">{{__('Vehicle')}}</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="{{ url('admin/send_notification_vehicle') }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="role">{{__('Notification Title')}}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="user">{{__('Select Vehicle')}}</label>
                                            <select name="vehicle_id[]" class="form-control select2" multiple required>
