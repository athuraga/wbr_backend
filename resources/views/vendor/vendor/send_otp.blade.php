            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark mb-5 font-weight-normal text-center">{{__('Welcome to ')}}<span
                                class="font-weight-bold">{{__('Vehicle')}}</span>
                        </h4>
                        @if (session('status'))
                        <script>
                        ...
                        <div class="text-muted text-center">
                            {{__("Don't send a code...???")}}<a
                                href="{{ url('vehicle/send_otp/'.$user->id) }}">{{__('Send code again..!!')}}</a>
                        </div>
                    </div>
                </div>
            </div>
