...
@section('title','Vehicle Delivery Timeslots')

@section('content')

<section class="section">
    <div class="section-header">
        <h1>{{ $vehicle->name }}&nbsp;{{__('Delivery Time Slots')}}</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ url('vehicle/home') }}">{{__('Dashboard')}}</a></div>
            <div class="breadcrumb-item">{{__('Vehicle delivery timeslot')}}</div>
        </div>
    </div>
