    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card p-3">
                    <form action="{{ url('vehicle/order_report') }}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <table class="table table-striped table-bordered report" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('vehicle discount price')}}</th>
                                    <th>{{__('delivery charge')}}</th>
                                    <th>{{__('Fleet Operator Name')}}</th>
                                    <th>{{__('Received From Fleet Operator')}}</th>
                                    <th>{{__('Receied From Fleet Operator?')}}</th>
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($order->vehicle_discount_price == null)
                                            <td>{{ $currency }}00</td>
                                            @else
                                            <td>{{ $currency }}{{ $order->vehicle_discount_price }}</td>
                                            @endif
                                            ...
                                            <td>
                                                @if ($order->vehicle_pending_amount == 1)
