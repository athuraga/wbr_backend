                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @can('vehicle_submenu_access')
                                    <a href="{{ url('vehicle/vehicle_menu/'.$menu->id) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" data-original-title="{{__('Add menu')}}">
