...
<head>
    ...
    <title>{{ $title }} | @yield('title','Vehicle register')</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        @endif
                        <form method="POST" action="{{ url('vehicle/register') }}">
                            @csrf
                            <div class="row">
                        ...
                        <div class="text-muted text-center">
                            {{__("Already have an account?")}} <a href="{{ url('vehicle/login') }}">{{__('Login')}}</a>
                        </div>
                        </div>
                    </div>
                </div>
