    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card p-3">
                    <form action="{{ url('vehicle/Orders') }}" method="post">
                        @csrf
                        <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <h4>{{__('Order')}}</h4>
                <div class="w-100">
                    @can('vehicle_order_add')
                        <a href="{{ url('vehicle/order/create') }}" class="btn btn-primary float-right">{{__('Add New')}}</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                            ...
                            <table class="table table-striped table-bordered orderTable" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        @endif
                                        <th>{{__('Fleet Operator Name')}}</th>
                                        @if (Session::get('vehicle_driver') == 0)
                                            <th>{{__('Received Amount From Fleet Operator')}}</th>
                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            @if (Session::get('vehicle_driver') == 0)
                                                @if ($order->payment_type == 'COD' && $order->vehicle_pending_amount == 0 && $order->order_status == 'COMPLETE')
                                                    <td>{{ $currency }}{{ $order->amount }}</td>
                                                    <td>
                                                        <a href="{{ url('vehicle/deliveryPerson/pending_amount/'.$order->id) }}" class="text-danger">{{__('Pending Amount')}}</a>
                                                    </td>
                                                @else
                                                    <td>{{ $currency }}{{00}}</td>
                                                    <td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$order->id) }}" onclick="show_order({{ $order->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0);" class="table-action btn btn-danger btn-action" onclick="deleteData('vehicle/order',{{ $order->id }},'Order')">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="{{ url('vehicle/print_thermal/'.$order->id) }}">
                                                    {{__('Print Bill')}}
                                                </a>
                                            </td>
                                        </tr>
                                ...
                                <tbody>
                                    @foreach ($pendingOrders as $pendingOrder)
                                        <tr>
                                            ...
                                            <td>{{ $pendingOrder['vehicle']->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$pendingOrder->id) }}" onclick="show_order({{ $pendingOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($approveOrders as $approveOrder)
                                        <tr>
                                            ...
                                            <td>{{ $approveOrder['vehicle']->name }}</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$approveOrder->id) }}" onclick="show_order({{ $approveOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($deliveredOrders as $deliveryOrder)
                                        <tr>
                                            ...
                                            <td>{{ $deliveryOrder['vehicle']->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$deliveryOrder->id) }}" onclick="show_order({{ $deliveryOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($pickUpOrders as $pickUpOrder)
                                        <tr>
                                            ...
                                            <td>{{ $pickUpOrder['vehicle']->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$pickUpOrder->id) }}" onclick="show_order({{ $pickUpOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($cancelOrders as $cancelOrder)
                                        <tr>
                                            ...
                                            <td>{{ $cancelOrder['vehicle']->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$cancelOrder->id) }}" onclick="show_order({{ $cancelOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                ...
                                <tbody>
                                    @foreach ($completeOrders as $completeOrder)
                                        <tr>
                                            ...
                                            <td>{{ $completeOrder['vehicle']->name }}</td>
                                            ...
                                            <td>
                                                <a href="{{ url('vehicle/order/'.$completeOrder->id) }}" onclick="show_order({{ $completeOrder->id }})" data-toggle="modal" data-target="#view_order">{{__('View Order')}}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table">
                    ...
                    <tr>
                        <th>{{__('Vehicle Commission')}}</th>
                        <td class="show_vehicle_amount"></td>
                    </tr>
                </table>
                <h6>{{__('tax')}}</h6>
