                        ...
                        <style>
                            * {
                            ...
                            <div class="row">
                                ...
                                <div class="column">
                                        <h3 class="font-weight-bold">{{__('Vehicle/Chef App')}}</h3>
                                            <ul class="app">
                                            <li>
                                            ...
                                            <ul class="app">
                                            <li>
                                            <a href="{{url('images/HomChfVehicle.apk')}}" target="_blank"> <img src="{{asset('images/google_play.png')}}" width="80%" height="80%"> </a>
                                            </li>
                                            </ul>                        
                                    </div>
                                </div>
