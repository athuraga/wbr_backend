...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form class="container-fuild" action="{{ url('vehicle/vehicle/' . $vehicle->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="logoContainer">
                                    <img id="image" src="{{ url($vehicle->image) }}" width="180" height="150"
                                        class="rounded-lg p-2">
                                </div>
                                <div class="fileContainer sprite">
                                    <span>{{ __('Image') }}</span>
                                    <input type="file" data-id="edit" name="image" value="Choose File" id="previewImage"
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="logoContainer">
                                    <img id="licence_doc" src="{{ $vehicle->vehicle_logo }}" width="200" height="182"
                                        class="rounded-lg p-2">
                                </div>
                                <div class="fileContainer">
                                    <span>{{ __('Image') }}</span>
                                    <input type="file" data-id="edit" name="vehicle_logo" value="Choose File"
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="number" value="{{ $vehicle->contact }}" name="contact"
                                    ...
                                    <select class="select2 form-control" name="vehicle_type_id[]" multiple="true">
                                        @foreach ($vehicle_types as $vehicle_type)
                                            <option value="{{ $vehicle_type->id }}"
                                                {{ in_array($vehicle_type->id, explode(',', $vehicle->vehicle_type_id)) ? 'selected' : '' }}>
                                        ...
                                        <div class="pac-card col-md-12 mb-3" id="pac-card">
                                            ...
                                            <div id="pac-container">
                                                <input id="pac-input" name="map_address"
                                                    value="{{ $vehicle->map_address }}" type="text"
                                                ...
                                                @else
                                                    ...
                                                    <input type="hidden" name="lang" value="{{ $vehicle->lang }}"
                                                        id="lang">
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                ...
                                                placeholder="{{ __('Vehicle full address') }}" id="location">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="for_two_person" placeholder="{{ __('Cost of two person') }}"
                                        value="{{ $vehicle->for_two_person }}" required
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="license_number">{{ __('Business License number') }}<span
                                            class="text-danger">&nbsp;*</span></label>
                                    <input type="text" name="license_number" value="{{ $vehicle->license_number }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="vehicle_type" class="form-control">
                                        <option value="all" {{ $vehicle->vehicle_type == 'all' ? 'selected' : '' }}>
                                            {{ __('All') }}</option>
                                        <option value="scooter" {{ $vehicle->vehicle_type == 'scooter' ? 'selected' : '' }}>
                                            {{ __('pure scooter') }}</option>
                                        <option value="bike" {{ $vehicle->vehicle_type == 'bike' ? 'selected' : '' }}>
                                            {{ __('none scooter') }}</option>
