...
@section('title','Vehicle Printer Setting')
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <form action="{{ url('vehicle/update_printer_setting') }}" method="post">
                    @csrf
                    <div class="card-body p-5">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="connector_type" class="form-control @error('connector_type') is_invalide @enderror">
                                    <option value="windows" {{ $vehicle->connector_type == 'windows' ? 'selected' : '' }}>{{__('windows')}}</option>
                                    <option value="cups" {{ $vehicle->connector_type == 'cups' ? 'selected' : '' }}>{{__('cups')}}</option>
                                    <option value="network" {{ $vehicle->connector_type == 'network' ? 'selected' : '' }}>{{__('network')}}</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="connector_descriptor" required class="form-control @error('connector_descriptor') is_invalide @enderror" placeholder="{{__('Connector Descriptor')}}" value="{{$vehicle->connector_descriptor}}">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="connector_port" class="form-control @error('connector_port') is_invalide @enderror" placeholder="{{__('Connector Port')}}" value="{{$vehicle->connector_port}}">
