...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ url('vehicle/vehicle_menu')}}">{{App\Models\Menu::find($submenu->menu_id)->name}}</a></div>
            <div class="breadcrumb-item active"><a href="{{ url('vehicle/vehicle_menu/'.$submenu->menu_id)}}">{{App\Models\Submenu::find($submenu->id)->name}}</a></div>
