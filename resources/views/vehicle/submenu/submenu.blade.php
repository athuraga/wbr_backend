            ...
            <div class="section-header-breadcrumb">
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a
                            href="{{ url('vehicle/vehicle_home') }}">{{ __('Dashboard') }}</a></div>
                    <div class="breadcrumb-item active"><a href="{{ url('vehicle/vehicle_menu') }}">{{ $menu->name }}</a>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label">{{ __('Item price') }}<span
                                    class="text-danger">&nbsp;*</span></label>
                            <input class="form-control @error('price') is-invalid @enderror" name="price" min=1
                                type="number" placeholder="{{ __('Item Price') }}" required
                                value="{{ old('price') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('price') is-invalid @enderror" name="price" type="number"
                                placeholder="{{ __('Item price') }}" id="update_price" min=1 required
                                value="{{ old('price') }}">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                @endphp
                <form action="{{ url('admin/submenu_import/' . $vehicle->id) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
