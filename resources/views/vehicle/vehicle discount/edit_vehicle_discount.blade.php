...
<section class="section">
    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ url('vehicle/vehicle_discount/') }}">{{__('Vehicle discount')}}</a></div>
    ...
    <div class="section-body">
        ...
        @endif
        <form class="container-fuild" action="{{ url('vehicle/vehicle_discount/'.$vehicleDiscount->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <input type="number" name="discount"
                                ...
                                placeholder="{{__('discount')}}" value="{{ $vehicleDiscount->discount }}" required=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <input type="number" name="max_discount_amount" value="{{ $vehicleDiscount->max_discount_amount }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <input type="number" name="min_item_amount" value="{{ $vehicleDiscount->min_item_amount }}"
