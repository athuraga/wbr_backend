...
class CreateOrderSettingItemTable extends Migration
{
     ...
     * @return void
     */
    // 'min_order_value','order_assign_manually','orderRefresh','order_dashboard_default_time','vehicle_order_max_time','driver_order_max_time','delivery_charge_type','min_value','max_value','charges',
    public function up()
    {
        Schema::create('order_setting_item', function (Blueprint $table) {
            ...
            $table->string('vehicle_order_max_time');
